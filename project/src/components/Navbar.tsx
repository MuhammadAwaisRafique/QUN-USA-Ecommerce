      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex border-t border-gray-200 py-2">
          <div className="flex space-x-8">
            ...
            <Link to="/contact" className="text-gray-600 hover:text-blue-600 transition-colors py-2">
              Contact
            </Link>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 space-y-4">
            ...
            <Link to="/contact" className="block text-gray-600 hover:text-blue-600 py-2" onClick={() => setIsMenuOpen(false)}>
              Contact
            </Link>
            ...
            {/* Mobile Cart */}
            <Link to="/cart" className="flex items-center space-x-2 text-gray-600 hover:text-blue-600 py-2" onClick={() => setIsMenuOpen(false)}>
            ...
            {user ? (
              <div className="space-y-2">
                ...
                {user.role === 'admin' && (
                  <Link to="/admin" className="block text-blue-600 hover:text-blue-800 py-2" onClick={() => setIsMenuOpen(false)}>
                    Admin Panel
                  </Link>
                )}
                <button
              ...
              <div className="space-y-2">
                <Link to="/login" className="block text-blue-600 hover:text-blue-800 py-2" onClick={() => setIsMenuOpen(false)}>
                  Login
                </Link>
                <Link to="/register" className="block bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-center" onClick={() => setIsMenuOpen(false)}>
                  Register
                </Link>
              </div>
            )}
